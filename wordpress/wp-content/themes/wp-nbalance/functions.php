...
function wpeHeadNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul class="list line">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function wpeHeadMobileNav() {
  ...
  array(
    ...
    'echo'            => true,
    'fallback_cb'     => 'wp_page_menu',
    'before'          => '<span class="list__item_link nb-s-1 js-menu-mobile-item">',
    'after'           => '</span>',
    'link_before'     => '',
    'link_after'      => '',
...
function register_html5_menu() {
  register_nav_menus(array(
    ...
    'header-mobile-menu' => __('Мобильное меню в шапке', 'wpeasy'),
...
class WPSE_78121_Sublevel_Walker extends Walker_Nav_Menu
{
    function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $output .= "\n$indent<div class='list__sub js-sub-list'><div class='list__sub_inner'><div class='list__sub_back'><a onclick='return false;' class='nbfont nb-s-1 js-sub-list-back'>Вернуться</a></div><div class='list__sub_list'><ul class='list sub-menu'>\n";
    }
