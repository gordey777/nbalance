    ...
    <table class="form-table">
        ...
        <tr valign="top">
			...
			<td>
				...
				<p><em>You can download image icon from <a target="_blank" href="http://www.cybernetikz.com/wordpress-magento-plugins/wordpress-plugins/easy-social-icons/#social-media-icons">here</a></em></p>
			</td>
        </tr>
